    ...
    return (
        <div className="footer">
            ...
            <div className="footer-right"> 
                <img className="footer-right-img" src="https://puui.qpic.cn/vupload/0/1575530292773_zk8ru850ein.png/0" />
                <p className="footer-right-text">Pindai kode QR untuk mengunduh sekarang!</p>
            </div>
        </div>
    )
}
